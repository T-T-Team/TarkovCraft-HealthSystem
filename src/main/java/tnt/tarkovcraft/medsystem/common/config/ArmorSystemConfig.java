...
public class ArmorSystemConfig {
    ...
    @Configurable.Comment("Additional armor protection per armor piece when using MODULAR_BOOSTED armor system")
    public float modularBoostedArmorMultiplier = 2.5F;

    @Configurable
    @Configurable.Comment("Configure which limbs are covered by specific armor pieces. Does nothing when using VANILLA armor system")
