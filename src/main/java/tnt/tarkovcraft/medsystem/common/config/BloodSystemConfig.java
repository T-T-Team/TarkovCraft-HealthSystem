...
public final class BloodSystemConfig {
    ...
    @Configurable
    @Configurable.Synchronized
    @Configurable.Comment(value = "Enables blood level display in health UI", localize = true)
    ...
    @Configurable
    @Configurable.Comment(value = "Will trigger downed state if playing alone in singleplayer", localize = true)
