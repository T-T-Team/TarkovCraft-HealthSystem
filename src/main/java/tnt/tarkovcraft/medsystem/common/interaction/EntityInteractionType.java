...
public final class EntityInteractionType<T extends EntityInteraction> {
    ...
    public static final ResourceLocation SHARED_ERROR_IDENTIFIER = MedicalSystem.createIdentifier("shared");
    ...
    public static Component getDisplayName(ResourceLocation identifier) {
        return Component.translatable(identifier.toLanguageKey(LOCALIZATION_PREFIX));
    }

    public static Component getErrorMessage(ResourceLocation identifier, String errorCode, Object... args) {
    ...
    public static final class Builder<T extends EntityInteraction> {
        ...
        public static <T extends EntityInteraction> Builder<T> create(ResourceLocation identifier) {
            return new Builder<>(identifier);
        }

        public static <T extends EntityInteraction> Builder<T> createSingleton(ResourceLocation identifier, T instance) {
            return Builder.<T>create(identifier)
                    .factory((origin, target) -> instance);
        }
