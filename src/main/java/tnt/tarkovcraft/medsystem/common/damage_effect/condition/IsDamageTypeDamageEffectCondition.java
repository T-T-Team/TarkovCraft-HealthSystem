...
public record IsDamageTypeDamageEffectCondition(Optional<TagKey<DamageType>> tag, Optional<ResourceLocation> identifier) implements DamageEffectCondition {
    ...
    public static final MapCodec<IsDamageTypeDamageEffectCondition> CODEC = RecordCodecBuilder.<IsDamageTypeDamageEffectCondition>mapCodec(instance -> instance.group(
            ...
            ResourceLocation.CODEC.optionalFieldOf("id").forGetter(IsDamageTypeDamageEffectCondition::identifier)
