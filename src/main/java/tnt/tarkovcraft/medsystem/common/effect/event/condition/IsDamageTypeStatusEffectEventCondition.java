...
public record IsDamageTypeStatusEffectEventCondition(Optional<TagKey<DamageType>> tag, Optional<Identifier> identifier) implements StatusEffectEventCondition {
    ...
    public static final MapCodec<IsDamageTypeStatusEffectEventCondition> CODEC = RecordCodecBuilder.<IsDamageTypeStatusEffectEventCondition>mapCodec(instance -> instance.group(
            ...
            Identifier.CODEC.optionalFieldOf("id").forGetter(IsDamageTypeStatusEffectEventCondition::identifier)
