...
public final class StatusEffectEventContext {
    ...
    private StatusEffectEventContext(LivingEntity entity, HealthContainer container, Limb limb, Map<ContextKey<?>, Object> parameters) {
    ...
    public float getDamage(boolean localDamage, float fallback) {
        ContextKey<Float> key = localDamage ? StatusEffectEventParams.DAMAGE_AMOUNT_LIMB : StatusEffectEventParams.DAMAGE_AMOUNT;
