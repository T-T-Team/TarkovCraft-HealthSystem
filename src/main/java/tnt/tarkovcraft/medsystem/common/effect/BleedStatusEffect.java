...
public final class BleedStatusEffect extends EntityCausedStatusEffect {
    ...
    public static final Identifier ICON_LIGHT_BLEED = StatusEffectHelper.getTextureResource(MedSystemConstants.MOD_ID, "light_bleed");
    public static final Identifier ICON_HEAVY_BLEED = StatusEffectHelper.getTextureResource(MedSystemConstants.MOD_ID, "heavy_bleed");
