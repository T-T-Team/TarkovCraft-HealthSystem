...
public final class MedSystemStatusEffectPredicates {
    ...
    public static final DeferredRegister<StatusEffectPredicateType<?>> REGISTRY = DeferredRegister.create(MedSystemRegistries.Keys.STATUS_EFFECT_PREDICATE, MedicalSystem.MOD_ID);
