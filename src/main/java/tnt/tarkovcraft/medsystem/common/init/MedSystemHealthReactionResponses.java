...
public final class MedSystemHealthReactionResponses {
    ...
    public static final DeferredRegister<HealthSourceEventType<?>> REGISTRY = DeferredRegister.create(MedSystemRegistries.Keys.HEALTH_REACTION_RESPONSE, MedicalSystem.MOD_ID);
