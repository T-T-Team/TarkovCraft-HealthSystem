...
public final class MedSystemStateFilters {
    ...
    public static final Holder<EntityStateMatcherType<?>> CUSTOM_POSE = REGISTRY.register("custom_pose", key -> new EntityStateMatcherType<>(key, CustomEntityPoseStateMatcher.CODEC));
