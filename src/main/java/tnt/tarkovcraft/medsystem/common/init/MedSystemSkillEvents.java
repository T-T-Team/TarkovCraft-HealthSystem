...
public final class MedSystemSkillEvents {
    ...
    public static final DeferredRegister<SkillTriggerEvent> REGISTRY = DeferredRegister.create(CoreRegistries.Keys.SKILL_TRIGGER_EVENT, MedSystemConstants.MOD_ID);
    ...
    public static final Holder<SkillTriggerEvent> LIMB_FIXED = REGISTRY.register("limb_fixed", SkillTriggerEvent::new);
}
