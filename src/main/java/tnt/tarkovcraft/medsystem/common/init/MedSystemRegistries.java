...
public final class MedSystemRegistries {
    ...
    public static final class Keys {
        ...
        public static final ResourceKey<Registry<EffectRecoveryApplicatorType<?>>> EFFECT_RECOVERY_APPLICATOR = ResourceKey.createRegistryKey(MedicalSystem.createIdentifier("effect_recovery_applicator"));
