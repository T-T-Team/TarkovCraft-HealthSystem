...
public final class MedSystemRegistries {
    ...
    public static final class Keys {
        ...
        public static final ResourceKey<Registry<StatusEffectEventSource>> STATUS_EFFECT_EVENT_SOURCE = ResourceKey.createRegistryKey(MedicalSystem.resource("status_effect_event/source"));
