...
public record AddStatusEffectEventAction(StatusEffectWithDelay effect, List<HealthEventFunction> durationModifiers, List<HealthEventFunction> delayModifiers) implements HealthEventAction {
    ...
    public static final MapCodec<AddStatusEffectEventAction> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ...
            HealthEventFunction.CODEC.listOf().optionalFieldOf("duration_modifiers", Collections.emptyList()).forGetter(AddStatusEffectEventAction::durationModifiers),
            HealthEventFunction.CODEC.listOf().optionalFieldOf("delay_modifiers", Collections.emptyList()).forGetter(AddStatusEffectEventAction::delayModifiers)
    ...
    public boolean apply(HealthEventContext ctx) {
        ...
        int duration = Mth.floor(HealthEventFunction.applyFunctions(statusEffect.getDuration(), ctx, this.durationModifiers));
