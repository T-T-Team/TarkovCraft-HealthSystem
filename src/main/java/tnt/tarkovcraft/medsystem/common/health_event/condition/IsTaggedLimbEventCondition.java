...
public record IsTaggedLimbEventCondition(ResourceLocation tag) implements HealthEventCondition {

    public static final MapCodec<IsTaggedLimbEventCondition> CODEC = ResourceLocation.CODEC
