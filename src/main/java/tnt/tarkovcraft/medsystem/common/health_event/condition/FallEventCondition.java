...
public record FallEventCondition(float minFallDistance, float modifier) implements HealthEventCondition {
    ...
    public static final MapCodec<FallEventCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ExtraCodecs.NON_NEGATIVE_FLOAT.optionalFieldOf("min_fall_distance", 0.0F).forGetter(FallEventCondition::minFallDistance),
            ExtraCodecs.NON_NEGATIVE_FLOAT.optionalFieldOf("modifier", 1.0F).forGetter(FallEventCondition::modifier)
