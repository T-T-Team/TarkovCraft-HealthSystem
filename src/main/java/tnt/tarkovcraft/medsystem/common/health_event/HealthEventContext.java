...
public final class HealthEventContext {
    ...
    private HealthEventContext(LivingEntity entity, HealthContainer container, Limb limb, Map<LootContextParam<?>, Object> parameters) {
    ...
    public float getDamage(boolean localDamage, float fallback) {
        LootContextParam<Float> key = localDamage ? HealthEventParams.DAMAGE_AMOUNT_LIMB : HealthEventParams.DAMAGE_AMOUNT;
