...
public final class HitInfo {
    ...
    private final Map<ResourceLocation, Object> metadata;

    private HitInfo(EntityHitboxContainer.LimbHitboxDefinition hitbox, Limb limb, AABB aabb, Vec3 entryPoint, Map<ResourceLocation, Object> metadata) {
        this.hitbox = hitbox;
        this.limb = limb;
        this.aabb = aabb;
    ...
    public <T> @Nullable T getMetadataValue(ResourceLocation key) {
        if (this.metadata == null)
            return null;
        return (T) this.metadata.get(key);
    }

    public boolean hasMetadataValue(ResourceLocation key) {
    ...
    public static final class Mutable {
        ...
        private Map<ResourceLocation, Object> metadata;
        ...
        public void setMetadataParam(ResourceLocation key, Object value) {
            if (this.metadata == null) {
