...
public final class Limb {
    ...
    public static final Codec<Limb> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.unboundedMap(ResourceLocation.CODEC, Codec.FLOAT).optionalFieldOf("reductions", Collections.emptyMap()).forGetter(t -> t.reductions)
    ...
    private final Object2FloatMap<ResourceLocation> reductions;
    ...
    private Limb(LimbDefinition definition, String limbCode, float health, float maxHealth, StatusEffectMap statusEffects, Map<ResourceLocation, Float> reductions) {
        this.definition = definition;
    ...
    public void addReduction(ResourceLocation identifier, float amount) {
        this.reductions.put(identifier, amount);
    }

    public void removeReduction(ResourceLocation identifier) {
        this.reductions.removeFloat(identifier);
    }

    public float getReduction(ResourceLocation identifier) {
