...
public final class PositionedAABB {
    ...
    public static final Codec<PositionedAABB> VEC_COMPONENT_CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Vec3.CODEC.fieldOf("pos").forGetter(PositionedAABB::center),
            MedsystemCodecs.VEC2_CODEC.fieldOf("size").forGetter(PositionedAABB::size)
    ).apply(instance, PositionedAABB::create));
