...
public record UnconsciousOptions(boolean allowSkip, boolean allowRescue, boolean downedStateAllowed, Component label, Set<Identifier> tags) {

    public static final Identifier TAG_DOWNED = MedicalSystem.createIdentifier("downed");
    ...
    public static final Codec<UnconsciousOptions> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codecs.hashSet(Identifier.CODEC).optionalFieldOf("tags", Collections.emptySet()).forGetter(UnconsciousOptions::tags)
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, UnconsciousOptions> STREAM_CODEC = StreamCodec.composite(
            ...
            Identifier.STREAM_CODEC.apply(ByteBufCodecs.collection(HashSet::new)), UnconsciousOptions::tags,
    ...
    public boolean is(Identifier tag) {
