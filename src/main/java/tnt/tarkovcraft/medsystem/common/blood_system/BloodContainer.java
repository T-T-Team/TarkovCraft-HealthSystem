...
public record BloodContainer(float capacity, float value, boolean refillable, Optional<ResourceLocation> bloodType) {

    public static final Codec<BloodContainer> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Codecs.NON_NEGATIVE_FLOAT.fieldOf("capacity").forGetter(BloodContainer::capacity),
            Codecs.NON_NEGATIVE_FLOAT.optionalFieldOf("value", 0.0F).forGetter(BloodContainer::value),
            Codec.BOOL.optionalFieldOf("refillable", true).forGetter(BloodContainer::refillable),
            ResourceLocation.CODEC.optionalFieldOf("blood_type").forGetter(BloodContainer::bloodType)
    ...
    public static final StreamCodec<ByteBuf, BloodContainer> STREAM_CODEC = StreamCodec.composite(
            ...
            ByteBufCodecs.optional(ResourceLocation.STREAM_CODEC), BloodContainer::bloodType,
            BloodContainer::new
    );
    ...
    public boolean isCompatible(ResourceLocation type) {
    ...
    public BloodContainer fill(float amount, ResourceLocation bloodType) {
