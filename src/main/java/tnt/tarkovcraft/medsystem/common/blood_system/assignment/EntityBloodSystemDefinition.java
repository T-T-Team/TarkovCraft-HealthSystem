...
public final class EntityBloodSystemDefinition {
    ...
    private EntityBloodSystemDefinition(Set<EntityType<?>> entityTypes, Map<Identifier, Integer> bloodTypes, NumberProvider bloodVolume, AttributeNumber bloodRecovery, UnconsciousModeSettings unconsciousMode, EntityShockData shockData, BloodEffectAttributes effectAttributes, List<BloodLevelEffectHolder> effectList) {
    ...
    public void bind(LivingEntity entity) {
        EntityType<?> type = entity.getType();
        Identifier bloodType = this.weightedBloodTypes.getRandomOrThrow(entity.getRandom());
    ...
    private WeightedList<Identifier> computeWeightedList() {
        WeightedList.Builder<Identifier> builder = WeightedList.builder();
