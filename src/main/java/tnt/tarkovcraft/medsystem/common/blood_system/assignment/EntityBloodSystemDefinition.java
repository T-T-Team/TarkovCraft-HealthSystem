...
public final class EntityBloodSystemDefinition {
    ...
    private EntityBloodSystemDefinition(Set<EntityType<?>> entityTypes, Map<Identifier, Integer> bloodTypes, NumberProvider bloodVolume, AttributeNumber bloodRecovery, UnconsciousModeSettings unconsciousMode, BloodEffectAttributes effectAttributes, List<BloodLevelEffectHolder> effectList) {
