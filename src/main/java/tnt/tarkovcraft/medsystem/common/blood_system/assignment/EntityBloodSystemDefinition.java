...
public final class EntityBloodSystemDefinition {
    ...
    private EntityBloodSystemDefinition(Set<EntityType<?>> entityTypes, Map<Identifier, Integer> bloodTypes, float bloodVolume, AttributeNumber bloodRecovery, UnconsciousModeSettings unconsciousMode, EntityShockData shockData, BloodEffectAttributes effectAttributes, List<BloodLevelEffectHolder> effectList) {
