...
public record RemoveVanillaAttributeModifierBloodLevelEffect(Holder<Attribute> attribute, ResourceLocation modifier) implements BloodLevelEffect {
    ...
    public static final MapCodec<RemoveVanillaAttributeModifierBloodLevelEffect> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ...
            ResourceLocation.CODEC.fieldOf("modifier").forGetter(RemoveVanillaAttributeModifierBloodLevelEffect::modifier)
    ...
    public BloodLevelEffectType<?> getType() {
        return MedSystemBloodLevelEffects.REMOVE_VANILLA_ATTRIBUTE_MODIFIER.value();
    }
}
